...
export GITOPS_REPO_URL=https://github.com/rhtap-qe-jsmid/saui3c24w-dotnet-basic-gitops
...
export REKOR_HOST=${REKOR_HOST-https://rekor-server-rhtap-tas.apps.cluster-r77zk.r77zk.sandbox3248.opentlc.com}
...
export TUF_MIRROR=${TUF_MIRROR-https://tuf-rhtap-tas.apps.cluster-r77zk.r77zk.sandbox3248.opentlc.com}
